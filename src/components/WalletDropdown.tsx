                ...
                {isEditingName ? (
                  <div className="flex space-x-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-2 bg-black/50 border border-orange-500/30 rounded-lg text-white ${isMobile ? 'text-xs' : 'text-sm'} focus:outline-none focus:border-orange-500 selectable touch-manipulation`}
                      style={{
